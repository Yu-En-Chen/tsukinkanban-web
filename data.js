...
export const railwayData = [
    ...
    { id: 'kanagawa', name: '神奈川県', kana: 'kanagawa kanagawa', status: '正常運転', hex: '#004B97', desc: '港灣部を含め、順調に運行されています。', detail: ['標誌: 海洋藍', '主要站: 橫濱、川崎'] },
    ...
    { id: 'toei-oedo', name: '都營 大江戸線', kana: 'おおえどせん oedo', status: '正常運転', hex: '#AE0000', desc: '大江戸線は全線で正常通り運轉しています。', detail: ['次發: 2分', '代表色: 洋紅'] }
];
