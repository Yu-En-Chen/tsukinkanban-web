export const dataSourceContent = `
    <div style="opacity: 0.85; line-height: 1.7;">
                        ...
                        <div style="margin-bottom: 18px;">
                            ...
                            <div style="display: flex; flex-direction: column; gap: 12px;">
                                ...
                                <div>
                                    ...
                                    <p style="color: var(--text-secondary); margin: 0; font-size: 0.85em; line-height: 1.7;">日本航空、全日本空輸（成田・羽田発着のみ）</p>
                                </div>
                            </div>
                        </div>
                        <br>
        ...
        <div style="padding: 12px 16px; background: rgba(120, 120, 128, 0.08); border-radius: 20px;">
            ...
            連絡先：<a href="#" data-eu="support" data-ed="tsukinkanban.com" style="color: inherit; text-decoration: underline; font-weight: 500;">お問い合わせ先</a></p>
        </div>
        <br>
